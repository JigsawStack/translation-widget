...
const initializeTranslationWidget = (e, n) => {
    ...
    async function g(n, a) {
      try {
        const o = h.get(n, a);
        if (o) return console.log("Retrieved from cache:", n, "->", o), o;
        const t = await fetch("https://api.jigsawstack.com/v1/ai/translate", {
          method: "POST",
          headers: { "Content-Type": "application/json", "x-api-key": e },
          body: JSON.stringify({ text: n, target_language: a }),
        });
        if (!t.ok) throw new Error(`Error translating text: ${t.statusText}`);
          ...
          for (let o = 0; o < n.length; o += a) {
            ...
            if (
              (c.forEach((n) => {
                ...
                if (!a) return;
                let o;
                if (a.hasAttribute("data-original-text"))
                  (o = n.textContent.trim()),
                    "en" !== t &&
                      "en" !== e &&
                      (o = a.getAttribute("data-original-text"));
                else {
                  const e = n.textContent.trim();
                  e && (a.setAttribute("data-original-text", e), (o = e));
                }
                o && (i.push(o), d.push(n));
              }),
              i.length > 0)
            ) {
              (await g(i, e)).forEach((e, n) => {
                d[n].textContent = e;
              });
            }
          }
