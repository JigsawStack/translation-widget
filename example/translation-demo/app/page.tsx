  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] relative">
      ...
      <img 
        src="/arrow.png"
        alt="Spiral Arrow" 
        className="absolute top-8 right-20 w-32 h-32 rotate-0 opacity-80 pointer-events-none select-none z-10"
      />
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="text-center sm:text-left max-w-2xl">
          <div className="flex flex-col items-center sm:items-start mb-6">
            <img src="https://jigsawstack.com/jigsaw_logo.svg" alt="Jigsaw Logo" className="w-1/2"/>
          </div>
